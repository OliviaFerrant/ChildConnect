...
Case.create(child_name: "Jessica Parker, Tom Parker, Emily Parker", family_name: "Parker, Smith", remote_photo_url: "https://i0.wp.com/www.healthline.com/hlcmsresource/images/topic_centers/1296x728_bruise-colors-H1.jpg?w=1155", state: "Open", address: "32 Mercer Street, Jersey City, New Jersey, United States of America", phone_number: "212-601-3254", summary: "A bruise has been found on the child by the primary school teacher. Parents claim that the child fell down the stairs but teachers say this is not the first time such an incident has occurred.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Chloe Johnson", family_name: "Johnson, Yvette", remote_photo_url: "https://i.dailymail.co.uk/i/pix/2014/03/17/article-0-1C5DAB4300000578-449_964x644.jpg", state: "Open", address: "7681 Roberts Drive Far Rockaway, NY 11691", phone_number: "212-401-9399", summary: "Domestic violence signalled by neighbour. Police has been called and after entering the premises found the child dirty and uncared for.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Emily Williams", family_name: "Williams, Kent", remote_photo_url: "http://coachvinnym.com/wp-content/uploads/2018/10/dirty-apartment-this-is-a-feeling-you-can-now-avoid-dirty-apartment-eviction.jpg", state: "Open", address: "Far Rockaway, New York, United States of America", phone_number: "212-301-2314", summary: "Absent from school for 30 days despite not producing any valid explanations. Father is absent from home and the mother has drug abuse and mental illness history", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Mia Ramos, Clarissa Jones", family_name: "Jones, Bill", remote_photo_url: "https://i0.wp.com/www.healthline.com/hlcmsresource/images/topic_centers/5986-bruised_ribs-648x364-body.jpg?w=1155&h=764", state: "Open", address: "1203 East New York Avenue, New York City, New York, United States of America", phone_number: "212-789-0098", summary: "Complained about being hit by step father - has bruised back and thighs. Child is also part of the wrestling team from where it is also possible for them to receive similar injuries.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Tyrina Brown", family_name: "Brown, Latisha", remote_photo_url: "http://1.bp.blogspot.com/-v2tTeCX1DOA/UoEEGFe99BI/AAAAAAAAATo/JooEIZAxR7w/s1600/dirty+flat+(3)+(1024+x+768).jpg", state: "Open", address: "222 Smith Avenue, Todt Hill, New York, United States of America", phone_number: "212-690-4052", summary: "Mother has been arrested for drunk and disorderly behaviour in the streets. She has no prior history.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Ranielle Hall", family_name: "Hall, Todrick", remote_photo_url: "https://live.staticflickr.com/162/417062984_04727ecf7f.jpg", state: "Open", address: "350 100th Avenue, New York City, New York, United States of America", phone_number: "212-098-1326", summary: "Dad has gone missing after an altercation with a relative. The child's mother has passed away and the child was found being cared by his 12yr old sister.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Latisha Woods", family_name: "Laurent, Allen", remote_photo_url: "https://i2-prod.dailyrecord.co.uk/incoming/article892491.ece/ALTERNATES/s615b/505FAC0B-A2FA-F210-71ADBCCAEA6844EE.jpg", state: "Open", address: "6800 100th Road, New York City, New York, United States of America", phone_number: "212-253-6473", summary: "The child has been repeatedly sick over a period of six months. Lately suffers from unexplained weight loss.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Rashawn Stewart", family_name: "Stewart, Shay", remote_photo_url: "https://static1.squarespace.com/static/5624272be4b0007a000e2091/t/587fbacf3e00be6f0d1da847/1484765914101/?format=1000w", state: "Open", address: "5000 100th Street, New York City, New York, United States of America", phone_number: "212-231-7819", summary: "Mental health issues are prevalent in the parents of the child. Neglect has been ongoing and the child was found by the neighbor walking on the sidewalk unsupervised.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Montraie Sanchez", family_name: "Sanchez, Maria", remote_photo_url: "https://i.pinimg.com/originals/06/2b/b6/062bb625146abb751d3b15b31757a1a6.jpg", state: "Open", address: "100 Brooklyn Bridge, Manhattan Community Board 1, New York, United States of America", phone_number: "212-601-2536", summary: "Alcoholic parents have been known to leave the child unattended but claim that he is cared for by the maternal grand mother.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Joshua Hart, Lily Hart", family_name: "Bennet, James", remote_photo_url: "https://islamicanews.com/files/2014/06/messyapt.jpg", state: "Open", address: "9 12th Avenue, Manhattan Community Board 9, New York, United States of America", phone_number: "212-111-2018", summary: "Family doctor is concerned by the weight of the baby who is severely under the normal rate of development - neglect is suspected", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Oliver Barnes", family_name: "Barnes, Courtney", remote_photo_url: "https://cdnblog.rentcafe.com/blog/wp-content/uploads/2012/01/MessyApartment.jpg", state: "Open", address: "56 56th Place, New York City, New York, United States of America", phone_number: "212-301-2018", summary: "Teacher reported that the child seems to be constantly tired and is not engaging in lessons", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Daniel Wood", family_name: "Wood, Bill", remote_photo_url: "https://i.redd.it/62cqzypfjnx01.jpg", state: "Open", address: "80 80th Drive, New York City, New York, United States of America", phone_number: "212-604-4908", summary: "Dad was just released from a long incarceration. The child seems to not be accepting the return of his father and has been involved in truancy", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Jack White", family_name: "Hernandez, Jonathan", remote_photo_url: "https://byemould.com/wp-content/uploads/2016/08/landlord-messy-apartment-tenant-viewing-property-estate-agent-byemould.jpg", state: "Open", address: "7 7th Avenue, Manhattan Community Board 4, New York, United States of America", phone_number: "212-231-4018", summary: "Friend of the child called our services following a violent altercation between the child and his step dad. ", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Jacob Young", family_name: "Young, Michael", remote_photo_url: "https://cdn.homedit.com/wp-content/uploads/2011/07/clean-interior-design-apartment.jpg", state: "Open", address: "65 65th Avenue, New York City, New York, United States of America", phone_number: "212-321-9876", summary: "Parents are divorced and mother is accusing father of not taking care of the child during their weekend visits.", start_date: d, end_date: d + 60)

d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "William Price", family_name: "Price, Morrison", remote_photo_url: "http://bipolardesign.co/wp-content/uploads/2018/06/cool-game-room-ideas-best-small-gaming-part-photos-gamer-bedroom-with-decorating-home.jpg", state: "Open", address: "450 Brooklyn Bridge, Manhattan Community Board 3, New York, United States of America", phone_number: "212-231-4348", summary: "Child has completely lost interest at school and is no longer taking part in sports event in which he was previously active. Abuse suspected.", start_date: d, end_date: d + 60)
