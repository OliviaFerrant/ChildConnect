...
d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Montraie", family_name: "Sanchez", remote_photo_url: "https://i.pinimg.com/originals/06/2b/b6/062bb625146abb751d3b15b31757a1a6.jpg", state: "Open", address: "100 Brooklyn Bridge, Manhattan Community Board 1, New York, United States of America", phone_number: "212-601-2536", summary: "Alcoolic parents have been known to leave the kid unattended but claim that he is cared for by the maternal grand mother.", start_date: d, end_date: d + 60)
...
d = Faker::Date.between(45.days.ago, Date.today)
Case.create(child_name: "Jack", family_name: "Hernandez", remote_photo_url: "https://byemould.com/wp-content/uploads/2016/08/landlord-messy-apartment-tenant-viewing-property-estate-agent-byemould.jpg", state: "Open", address: "7 7th Avenue, Manhattan Community Board 4, New York, United States of America", phone_number: "212-231-4018", summary: "Friend of the child  has called in our services following a volent altercation between the child and his step dad. ", start_date: d, end_date: d + 60)
